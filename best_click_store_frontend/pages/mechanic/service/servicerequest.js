...
export default function ChangeProfile() {
    ...
    const handleOrder = async (reqid) => {
        router.push(`./serviceresponse?req=${reqid}`);
    }
                                            ...
                                            <div className="overflow-x-auto">
                                                <tbody className="table">
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <button className="btn btn-ghost btn-xs"  onClick={() => handleOrder(jsonData[index].request_id)}>Edit Status</button>
                                                        </th>
                                                    </tr>
                                                </tbody>
                                            </div>
